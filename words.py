...
# create the display surface object (x, y) is the height and width of pygame window
win = pygame.display.set_mode((500, 500))
 
# set the pygame window name 
pygame.display.set_caption("Scrolling Text")
 
# setting the pygame font style(1st parameter) and size of font(2nd parameter)
Font = pygame.font.SysFont('timesnewroman',  30)
 
# define the RGB value for white, green, yellow, orange colour 
white=(255, 255, 255)
yellow=(255, 255, 0)
green=(0, 255, 255)
orange=(255, 100, 0)
...
# Split the text into letters  3rd parameter is font colour and  4th parameter is Font background
...
# assigning values to i and c variable 
i=0
c=1
...
while not done:
    ...
    win.fill(white)
    if(c%6==0):    
        # Scrolling the text in diagonal on right side of the Screen.
